...
public class EventController {
  ...
  @PostMapping
  public ResponseEntity<CreateEventResponseDto> createEvent(@RequestBody @Valid CreateEventRequestDto createEventRequestDto, @AuthenticationPrincipal Jwt jwt) {
